...
#
# Example usage:
#    ./split-observe-one-book.sh en huck-finn.txt localhost 17001
#
...
observer=./observe-one.pl

splitdir=split-books
donedir=observed-books

echo "Splitting and observing $fullpath as '$filename'"
...
cat "$splitdir/$filename" | $observer $coghost $cogport
