...
This script copies downloaded files and places them in the directory specified at the head of the script. This defaults to:```
destination="../../text/en-tranche-1"
```
which creates a text directory at the same level as the language directory which contains this ReadMe.
